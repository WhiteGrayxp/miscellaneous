...
legend('NOMA pSIC \itN_{\rmth}\rm=1.5','NOMA ipSIC \itN_{\rmth}\rm=1.5','OMA \itN_{\rmth}\rm=1.5','NOMA pSIC \itN_{\rmth}\rm=0.75','NOMA ipSIC \itN_{\rmth}\rm=0.75','OMA \itN_{\rmth}\rm=0.75','Fontname','Times New Roman');
