...
legend('NOMA1, pSIC','NOMA1, ipSIC, \beta=0.1','NOMA1, ipSIC, \beta=0.2','NOMA2, pSIC','NOMA2, ipSIC, \beta=0.1','NOMA2, ipSIC, \beta=0.2','OMA','FontSize',14,'Fontname','Times New Roman');
