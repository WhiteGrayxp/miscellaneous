...
legend('Analysis, pSIC','Simulation, pSIC','Asymptotic, analysis, pSIC','Analysis, ipSIC','Simulation, ipSIC','Asymptotic, analysis, ipSIC','Fontname','Times New Roman');
...
legend('Analysis','Simulation','Asymptotic, analysis','Fontname','Times New Roman');
xlabel('Transmitter SNR (dB)','Fontname','Times New Roman');
ylabel('Outage Probability','Fontname','Times New Roman');
set(gca,'FontSize',12,'Fontname', 'Times New Roman');
